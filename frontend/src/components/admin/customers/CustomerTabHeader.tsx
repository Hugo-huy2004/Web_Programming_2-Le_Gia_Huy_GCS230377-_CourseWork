  ...
  return (
    <div className="flex flex-col items-start justify-between gap-6 border-b border-border/40 pb-8 md:flex-row md:items-end">
      <div className="space-y-2">
        ...
        <h2 className="font-serif text-4xl italic tracking-tight text-foreground">Collector Directory</h2>
      </div>
      <p className="font-serif text-[15px] italic text-muted-foreground/60">
